...
class GetFriendListsRespondDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendListsRespond> _instance;
} _GetFriendListsRespond_default_instance_;
}  // namespace fixbug
...
static void InitDefaultsscc_info_GetFriendListsRespond_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendListsRespond_default_instance_;
    new (ptr) ::fixbug::GetFriendListsRespond();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendListsRespond::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListsRespond_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendListsRespond_test_2eproto}, {
...
static void InitDefaultsscc_info_LoginRespond_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_LoginRespond_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_LoginRespond_test_2eproto}, {
      &scc_info_ResultCode_test_2eproto.base,}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsRespond, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsRespond, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsRespond, friend_list_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 35, -1, sizeof(::fixbug::GetFriendListsRespond)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendListsRespond_default_instance_),
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ug.LoginRequest\032\024.fixbug.LoginRespond\022M\n"
  "\rGetFriendList\022\035.fixbug.GetFriendListsRe"
  "quest\032\035.fixbug.GetFriendListsRespondB\003\200\001"
  "\001b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_2eproto_sccs[6] = {
  ...
  &scc_info_GetFriendListsRespond_test_2eproto.base,
  &scc_info_LoginRequest_test_2eproto.base,
  &scc_info_LoginRespond_test_2eproto.base,
  &scc_info_ResultCode_test_2eproto.base,
  &scc_info_User_test_2eproto.base,
};
...
void LoginRespond::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LoginRespond_test_2eproto.base);
...
void GetFriendListsRespond::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListsRespond_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendListsRespond::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendListsRespond* msg);
};

const ::fixbug::ResultCode&
GetFriendListsRespond::_Internal::result(const GetFriendListsRespond* msg) {
  return *msg->result_;
}
GetFriendListsRespond::GetFriendListsRespond()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.GetFriendListsRespond)
}
GetFriendListsRespond::GetFriendListsRespond(const GetFriendListsRespond& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendListsRespond)
}

void GetFriendListsRespond::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListsRespond_test_2eproto.base);
  result_ = nullptr;
}

GetFriendListsRespond::~GetFriendListsRespond() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendListsRespond)
  SharedDtor();
}

void GetFriendListsRespond::SharedDtor() {
  if (this != internal_default_instance()) delete result_;
}

void GetFriendListsRespond::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendListsRespond& GetFriendListsRespond::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListsRespond_test_2eproto.base);
  return *internal_default_instance();
}


void GetFriendListsRespond::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendListsRespond)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendListsRespond::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListsRespond::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendListsRespond)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendListsRespond)
  return target;
}

size_t GetFriendListsRespond::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListsRespond)
  size_t total_size = 0;
...
void GetFriendListsRespond::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendListsRespond)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListsRespond* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListsRespond>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendListsRespond)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendListsRespond)
    MergeFrom(*source);
  }
}

void GetFriendListsRespond::MergeFrom(const GetFriendListsRespond& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListsRespond)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendListsRespond::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendListsRespond)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendListsRespond::CopyFrom(const GetFriendListsRespond& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendListsRespond)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendListsRespond::IsInitialized() const {
  return true;
}

void GetFriendListsRespond::InternalSwap(GetFriendListsRespond* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendListsRespond::GetMetadata() const {
  return GetMetadataStatic();
}
    ...
    case 1:
      GetFriendList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListsRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendListsRespond*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetFriendListsRespond::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
void UserServiceRpc_Stub::GetFriendList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                              ...
                              ::fixbug::GetFriendListsRespond* response,
                              ::google::protobuf::Closure* done) {
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListsRespond* Arena::CreateMaybeMessage< ::fixbug::GetFriendListsRespond >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::GetFriendListsRespond >(arena);
}
