...
class GetFriendListsRespond;
class GetFriendListsRespondDefaultTypeInternal;
extern GetFriendListsRespondDefaultTypeInternal _GetFriendListsRespond_default_instance_;
class LoginRequest;
...
template<> ::fixbug::GetFriendListsRespond* Arena::CreateMaybeMessage<::fixbug::GetFriendListsRespond>(Arena*);
template<> ::fixbug::LoginRequest* Arena::CreateMaybeMessage<::fixbug::LoginRequest>(Arena*);
template<> ::fixbug::LoginRespond* Arena::CreateMaybeMessage<::fixbug::LoginRespond>(Arena*);
...
class LoginRespond :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.LoginRespond) */ {
 public:
  LoginRespond();
  ...
  inline void Swap(LoginRespond* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline LoginRespond* New() const final {
    return CreateMaybeMessage<LoginRespond>(nullptr);
  }

  LoginRespond* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  // @@protoc_insertion_point(class_scope:fixbug.LoginRespond)
 private:
  class _Internal;
...
class GetFriendListsRespond :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListsRespond) */ {
 public:
  GetFriendListsRespond();
  virtual ~GetFriendListsRespond();

  GetFriendListsRespond(const GetFriendListsRespond& from);
  GetFriendListsRespond(GetFriendListsRespond&& from) noexcept
    : GetFriendListsRespond() {
    *this = ::std::move(from);
  }

  inline GetFriendListsRespond& operator=(const GetFriendListsRespond& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListsRespond& operator=(GetFriendListsRespond&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendListsRespond& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendListsRespond* internal_default_instance() {
    return reinterpret_cast<const GetFriendListsRespond*>(
               &_GetFriendListsRespond_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GetFriendListsRespond& a, GetFriendListsRespond& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListsRespond* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFriendListsRespond* New() const final {
    return CreateMaybeMessage<GetFriendListsRespond>(nullptr);
  }

  GetFriendListsRespond* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendListsRespond>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendListsRespond& from);
  void MergeFrom(const GetFriendListsRespond& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListsRespond* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListsRespond";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListsRespond)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool LoginRespond::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool LoginRespond::has_result() const {
  return _internal_has_result();
}
inline void LoginRespond::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& LoginRespond::_internal_result() const {
...
inline const ::fixbug::ResultCode& LoginRespond::result() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRespond.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* LoginRespond::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.LoginRespond.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* LoginRespond::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* LoginRespond::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.LoginRespond.result)
  return _internal_mutable_result();
}
inline void LoginRespond::set_allocated_result(::fixbug::ResultCode* result) {
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginRespond.result)
}

// bool success = 2;
inline void LoginRespond::clear_success() {
  success_ = false;
}
inline bool LoginRespond::_internal_success() const {
  return success_;
}
inline bool LoginRespond::success() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRespond.success)
  return _internal_success();
}
inline void LoginRespond::_internal_set_success(bool value) {
  
  success_ = value;
}
inline void LoginRespond::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginRespond.success)
}
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListsRespond::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriendListsRespond::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListsRespond::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListsRespond::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListsRespond::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsRespond.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* GetFriendListsRespond::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsRespond.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListsRespond::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListsRespond::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsRespond.result)
  return _internal_mutable_result();
}
inline void GetFriendListsRespond::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsRespond.result)
}

// repeated .fixbug.User friend_list = 2;
inline int GetFriendListsRespond::_internal_friend_list_size() const {
  return friend_list_.size();
}
inline int GetFriendListsRespond::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetFriendListsRespond::clear_friend_list() {
  friend_list_.Clear();
}
inline ::fixbug::User* GetFriendListsRespond::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsRespond.friend_list)
  return friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsRespond::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsRespond.friend_list)
  return &friend_list_;
}
inline const ::fixbug::User& GetFriendListsRespond::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::fixbug::User& GetFriendListsRespond::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsRespond.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GetFriendListsRespond::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::fixbug::User* GetFriendListsRespond::add_friend_list() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsRespond.friend_list)
  return _internal_add_friend_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsRespond::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsRespond.friend_list)
  return friend_list_;
}
