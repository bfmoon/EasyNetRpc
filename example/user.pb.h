...
// bool success = 2;
inline void RegisterResponce::clear_success() {
  success_ = false;
}
inline bool RegisterResponce::_internal_success() const {
  return success_;
}
inline bool RegisterResponce::success() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterResponce.success)
  return _internal_success();
}
inline void RegisterResponce::_internal_set_success(bool value) {
  
  success_ = value;
}
inline void RegisterResponce::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterResponce.success)
}
